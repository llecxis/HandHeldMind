...
class VideoRecorder():  
    ...
    def __init__(self, name="temp_video.avi", fourcc="MJPG", sizex=1280, sizey=720, camindex=0, fps=30):
        #fourcc = cv2.VideoWriter_fourcc(*'XVID')
        self.open = True
        self.device_index = 'rtsp://192.168.1.111:8553/PSIA/Streaming/channels/1?videoCodecType=MPEG4' #camindex
